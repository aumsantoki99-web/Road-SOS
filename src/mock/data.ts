...
export const mockHospitals: Hospital[] = [
  ...
  {
    id: 'police-001',
    name: 'Rajkot Central Police Station',
    address: 'Police Head Quarters, Rajkot',
    phone: '100',
    distanceKm: 3.5,
    etaMinutes: 10,
    isEmergencyCenter: true,
    latitude: 22.2884,
    longitude: 70.7711,
    specialties: ['Police', 'Emergency Response'],
    serviceType: 'police',
  },
  {
    id: 'tow-001',
    name: 'Patel Auto Towing & Rescue',
